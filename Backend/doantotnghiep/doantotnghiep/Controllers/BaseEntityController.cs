...
namespace doantotnghiep.Controllers
{
    ...
    public class BaseEntityController<TEntity> : ControllerBase
    {
        ...
        /// CreatedBy: TTLONG (26/7/2021)
        [HttpGet("paging")]
        public virtual IActionResult GetAllPaging(int pageIndex, int pageSize, string? queryText)
        {

            try
            {
                ServiceResult = _baseService.GetAllPaging(pageIndex, pageSize, queryText);               
                return Ok(ServiceResult);//StatusCode(200,"MISA")
            }
