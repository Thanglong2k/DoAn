...
namespace Core.Services
{
    public class BaseService<TEntity>:IBaseService<TEntity> where TEntity : BaseEntity
    {
        ...
        /// </returns>
        /// CreatedBy: TTLONG (28/7/2021)
        public virtual ServiceResult GetAllPaging(int pageIndex, int pageSize, string queryText)
        {

            ServiceResult.Data = _baseRepository.GetAllPaging(pageIndex, pageSize, queryText);
            ServiceResult.MISACode = Core.Const.Const.MISACodeSuccess;
            ServiceResult.UserMsg = string.Format(Core.Properties.Resources.Msg_Success);
            return ServiceResult;
        }
