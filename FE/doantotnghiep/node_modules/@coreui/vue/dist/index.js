...
const CAccordionBody = vue.defineComponent({
    ...
    setup(_, { slots }) {
        ...
        return () => vue.h(CCollapse, { class: 'accordion-collapse', visible: visible.value }, {
...
const CAccordionCollapse = vue.defineComponent({
...
const CAccordionHeader = vue.defineComponent({
    ...
    setup(_, { slots }) {
        return () => vue.h('div', { class: ['accordion-header'] }, vue.h(CAccordionButton, {}, {
...
const CCardHeader = vue.defineComponent({
    ...
    setup(props, { slots }) {
        return () => vue.h(props.component, { class: 'card-header' }, slots.default && slots.default());
    },
});
...
const CCardLink = vue.defineComponent({
    ...
    setup(props, { slots }) {
        return () => vue.h(CLink, { class: 'card-link', href: props.href }, { default: () => slots.default && slots.default() });
    },
});

const CCardSubtitle = vue.defineComponent({
    name: 'CCardSubtitle',
    props: {
        /**
         * Component used for the root node. Either a string to use a HTML element or a component.
    ...
    setup(props, { slots }) {
        return () => vue.h(props.component, { class: 'card-subtitle' }, slots.default && slots.default());
    },
});

const CCardText = vue.defineComponent({
    name: 'CCardText',
    props: {
        /**
         * Component used for the root node. Either a string to use a HTML element or a component.
    ...
    setup(props, { slots }) {
        return () => vue.h(props.component, { class: 'card-text' }, slots.default && slots.default());
    },
});

const CCardTitle = vue.defineComponent({
    name: 'CCardTitle',
    props: {
        /**
         * Component used for the root node. Either a string to use a HTML element or a component.
    ...
    setup(props, { slots }) {
        return () => vue.h(props.component, { class: 'card-title' }, slots.default && slots.default());
    },
});
...
const CCarousel = vue.defineComponent({
    ...
    setup(props, { slots }) {
        ...
        vue.provide('setAnimating', setAnimating);
        vue.provide('setCustomInterval', setCustomInterval);
        ...
        return () => vue.h('div', {
            ...
            props.controls && [
                vue.h('button', {
                    ...
                    vue.h('span', { class: 'carousel-control-prev-icon', ariaHidden: 'true' }),
                    vue.h('span', { class: 'visually-hidden' }, 'Previous'),
                ]),
                vue.h('button', {
                    type: 'button',
                    ...
                    vue.h('span', { class: 'carousel-control-next-icon', ariaHidden: 'true' }),
                    vue.h('span', { class: 'visually-hidden' }, 'Next'),
                ]),
            ],
        ]);
    },
...
const CCarouselCaption = vue.defineComponent({
...
const CDropdownItem = vue.defineComponent({
    name: 'CDropdownItem',
    props: {
        /**
         * Toggle the active state for the component.
...
const CDropdownHeader = vue.defineComponent({
...
const CDropdownDivider = vue.defineComponent({
...
const CHeader = vue.defineComponent({
    ...
    setup(props, { slots }) {
        return () => vue.h('div', { class: ['header', { [`header-${props.position}`]: props.position }] }, props.container
...
const CHeaderBrand = vue.defineComponent({
    ...
    setup(props, { slots }) {
        return () => vue.h(props.component, { class: 'header-brand' }, slots.default && slots.default());
    },
});

const CHeaderDivider = vue.defineComponent({
    name: 'CHeaderDivider',
    setup(_, { slots }) {
        return () => vue.h('div', { class: 'header-divider' }, slots.default && slots.default());
    },
});

const CHeaderNav = vue.defineComponent({
    name: 'CHeaderNav',
    props: {
        /**
         * Component used for the root node. Either a string to use a HTML element or a component.
...
const CHeaderText = vue.defineComponent({
    name: 'CHeaderText',
    setup(_, { slots }) {
        return () => vue.h('span', { class: 'header-text' }, slots.default && slots.default());
    },
});

const CHeaderToggler = vue.defineComponent({
    name: 'CHeaderToggler',
    setup(_, { slots }) {
        return () => vue.h('button', {
        ...
        }, slots.default ? slots.default() : vue.h('span', { class: ['header-toggler-icon'] }));
    },
});
...
const CImage = vue.defineComponent({
    name: 'CImage',
    props: {
        /**
...
const CListGroup = vue.defineComponent({
    name: 'CListGroup',
    props: {
        /**
         * Component used for the root node. Either a string to use a HTML element or a component.
...
const CModalBody = vue.defineComponent({
    name: 'CModalBody',
    setup(_, { slots }) {
        return () => vue.h('div', { class: 'modal-body' }, slots.default && slots.default());
    },
});

const CModalFooter = vue.defineComponent({
    name: 'CModalFooter',
    setup(_, { slots }) {
        return () => vue.h('div', { class: 'modal-footer' }, slots.default && slots.default());
    },
});
...
const CModalHeader = vue.defineComponent({
    ...
    setup(props, { slots }) {
        ...
        return () => vue.h('span', { class: 'modal-header' }, [
            slots.default && slots.default(),
            props.closeButton && vue.h(CCloseButton, { onClick: () => handleDismiss() }, ''),
        ]);
    },
});

const CModalTitle = vue.defineComponent({
    name: 'CModalTitle',
    props: {
        /**
         * Component used for the root node. Either a string to use a HTML element or a component.
    ...
    setup(props, { slots }) {
        return () => vue.h(props.component, { class: 'modal-title' }, slots.default && slots.default());
    },
});
...
const CNav = vue.defineComponent({
    name: 'CNav',
    props: {
        /**
         * Component used for the root node. Either a string to use a HTML element or a component.
...
const CNavGroupItems = vue.defineComponent({
    name: 'CNavGroupItems',
    setup(_, { slots }) {
        return () => vue.h('ul', { class: 'nav-group-items' }, slots.default && slots.default());
    },
});
...
const CNavTitle = vue.defineComponent({
    name: 'CNavTitle',
    setup(_, { slots }) {
        return () => vue.h('li', { class: 'nav-title' }, slots.default && slots.default());
    },
});
...
const CNavbarText = vue.defineComponent({
    name: 'CNavbarText',
    setup(_, { slots }) {
        return () => vue.h('span', { class: 'navbar-text' }, slots.default && slots.default());
    },
});

const CNavbarToggler = vue.defineComponent({
    name: 'CNavbarToggler',
    setup(_, { slots }) {
        return () => vue.h('button', {
            class: 'navbar-toggler',
        }, slots.default ? slots.default() : vue.h('span', { class: ['navbar-toggler-icon'] }));
    },
});
...
const COffcanvasBody = vue.defineComponent({
    name: 'COffcanvasBody',
    setup(_, { slots }) {
        return () => vue.h('div', { class: 'offcanvas-body' }, slots.default && slots.default());
    },
});

const COffcanvasHeader = vue.defineComponent({
    name: 'COffcanvasHeader',
    setup(_, { slots }) {
        return () => vue.h('div', { class: 'offcanvas-header' }, slots.default && slots.default());
    },
});

const COffcanvasTitle = vue.defineComponent({
    ...
    setup(props, { slots }) {
        return () => vue.h(props.component, { class: 'offcanvas-title' }, slots.default && slots.default());
    },
});
        ...
        return () => [
            vue.h(vue.Teleport, {
                ...
                vue.h('div', {
                    ...
                    vue.h('div', { class: 'popover-arrow', 'data-popper-arrow': '' }),
...
const CTabContent = vue.defineComponent({
    name: 'CTabContent',
    setup(_, { slots }) {
        return () => vue.h('div', { class: 'tab-content' }, slots.default && slots.default());
    },
});
...
const CToastBody = vue.defineComponent({
    name: 'CToastBody',
    setup(_, { slots }) {
        return () => vue.h('div', { class: 'toast-body' }, slots.default && slots.default());
    },
});

const CToastClose = vue.defineComponent({
    name: 'CToastClose',
    props: {
        /**
         * Component used for the root node. Either a string to use a HTML element or a component.
...
const CToastHeader = vue.defineComponent({
    name: 'CToastHeader',
    props: {
        /**
    ...
    setup(props, { slots, emit }) {
        return () => vue.h('div', { class: 'toast-header' }, [
            slots.default && slots.default(),
            props.closeButton &&
                vue.h(CToastClose, {
                    onClose: () => emit('close'),
        ...
        return () => [
            vue.h(vue.Teleport, {
                ...
                vue.h('div', {
                    ...
                    vue.h('div', { class: 'tooltip-arrow', 'data-popper-arrow': '' }),
                    (props.content || slots.content) &&
            ...
            vue.h(CCardBody, {
                ...
                vue.h('div', {}, [
                    (props.value || slots.value) &&
                        vue.h('div', { class: 'fs-4 fw-semibold' }, {
...
const CWidgetStatsC = vue.defineComponent({
    name: 'CWidgetStatsC',
    props: {
        /**
         * Sets the color context of the component to one of CoreUI’s themed colors.
                        ...
                        props.values.map((value, index) => [
                            ...
                            vue.h(CCol, {}, {
                                default: () => [
                                    ...
                                    vue.h(CCol, { class: 'text-uppercase text-medium-emphasis small' }, () => value.title),
                                ],
                            }),
                        ]),
                }),
...
const CWidgetStatsE = vue.defineComponent({
     ...
     */
    setup(props, { slots }) {
        return () => vue.h(CCard, {}, () => vue.h(CCardBody, {
            class: 'text-center',
        }, () => [
            (props.title || slots.title) &&
                vue.h('div', {
    ...
    setup(props, { slots }) {
        return () => vue.h(CCard, {}, {
            default: () => [
                ...
                slots.footer && vue.h(CCardFooter, {}, () => slots.footer && slots.footer()),
            ],
        });
    },
});
...
exports.CCardPlugin = CCardPlugin;
...
exports.CCarouselPlugin = CCarouselPlugin;
exports.CCloseButton = CCloseButton;
exports.CCloseButtonPlugin = CCloseButtonPlugin;
exports.CCol = CCol;
...
exports.CFormPlugin = CFormPlugin;
...
exports.CGridPlugin = CGridPlugin;
...
exports.COffcanvasPlugin = COffcanvasPlugin;
...
exports.CSpinnerPlugin = CSpinnerPlugin;
...
exports.CToastPlugin = CToastPlugin;
